...
<body>
	...
	<fieldset>
		...
		<div class="prsnl">
			<form action="stuprofupdate.php" method="post">
			<div class="input">
				<table>
					<tr>
			...
			<div class="input"><tr>
				...
				<td><input type="text" name="sem" value="<?php echo $sem;?>" required=""></td></tr>
			</div>
			<div class="input"><tr>
	...
	<center><form action="stuprof.php"><button name="but2">Cancel</button></form></center>
	</fieldset>
	<div class="footer">
...
if(isset($_POST['but1']))
{
  ...
  echo "$found";*/
  if ($found) {	
	  $update="update studentprof set Name='$fname',Date='$birth',Department='$depar',Semester='$sem',mail='$mail',Contact='$cont',Address='$address' where ID='$name' ";
		...
		if($run1)
			{
				...
				echo"</script>";
				echo"<script>window.open('stuprof.php','_self')</script>";
			}
		else{
