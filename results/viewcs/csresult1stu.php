...
$id=$_SESSION['csres'];
$sql1="select ID from resultcs where Semester='1'";
...
if($found){
	...
	$name=$row['Name'];
	$sql1="select * from resultcs where Semester='1'";
	$run1=mysqli_query($db,$sql1);
...
<body>
	...
	<div class="heading">
		...
		<p class="neo"><b>Semester:&nbsp&nbsp</b>1</p><br>
		<p class="neo"><b>Updated on:&nbsp&nbsp<?php echo $date;?></b></p><br>
	</div>
	...
	<div class="links">
		<ul>
		  ...
		  <li><a href="../intemresult.php"><b><p>Results</p></a></li>
