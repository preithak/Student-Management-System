...
$sem1=$_SESSION['sem7'];
$found=false;
$sql1="select ID from studentprof where Semester='$sem1' and Department='$depar1' ";
...
<body>
	...
	<a href="chgstuid.php" class="chgusn">Click here to Change the ID(USN)</a>
	</fieldset>
	<div class="footer">
...
if(isset($_POST['butups']))
{
  ...
  $update="update studentprof set Name='$fname',Date='$birth',Department='$depar',Semester='$sem',mail='$mail',Contact='$cont',Address='$address' where ID='$id' ";
