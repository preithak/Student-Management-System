...
$id=$_SESSION['id10'];
$depar1=$_SESSION['dep10'];
$sem1=$_SESSION['sem10'];

$sql1="select ID from result where Semester='$sem1' and Department='$depar1'";
...
if($found){
	...
	$name=$row['Name'];
	$sql1="select * from result where Semester='$sem1'";
	$run1=mysqli_query($db,$sql1);
...
<head>
	<title>Result </title>
	<link rel="stylesheet" type="text/css" href="../results/result1.css">
</head>
<body>
	<div class="head1">
	...
	<div class="links">
		<ul>
		  ...
		  <li><a href="intemresultadmin.php"><b><p>Results</p></a></li>
		  <li><a href="admin.php"><p>Profile</p></a></li>
