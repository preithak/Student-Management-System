...
session_start();
	...
	else if(!($_SESSION['id14']))
	{
		header("location:admin.php");
	}
$id=$_SESSION['id14'];
$depar1=$_SESSION['dep14'];
$sem1=$_SESSION['sem14'];
$sql4="select ID, Department from studentprof";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../atten/updattend2.css">
</head>
<body>
	<div class="prof1">
	...
	<section class="sec">
		...
		<table>
		    ...
		    <tr>
				...
				<div class="button">
				<button  name="but1" class="button">Update</button>
				</div>
			</form>
			<form action="admin.php"><button name="but2">Cancel</button></form>
	</section></p>
<div class="footer">
